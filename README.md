...
<p align="center">
  <img src="./imgs/0.jpg" alt="代码修改" width="600" />
</p> 

<p align="center">
  <img src="./imgs/6.jpg" alt="地图" width="600" />
</p> 
...
<p align="center">
  <img src="./imgs/3.jpg" alt="![实验](./imgs/3.jpg)" width="900" />
</p> 

1. $\beta=3$  
<p align="center">
  <img src="./imgs/4.jpg" alt="![实验](./imgs/3.jpg)" width="900" />
</p> 

1. $\beta=5$  
<p align="center">
  <img src="./imgs/5.jpg" alt="![实验](./imgs/3.jpg)" width="900" />
</p> 
...
|-- ACA_matlab.m 参考：[B站 小黎的Ally：路径规划与轨迹跟踪系列算法学习_第2讲_蚁群算法](https://www.bilibili.com/video/BV1dA411s7Eb/?spm_id_from=333.1007.top_right_bar_window_history.content.click&vd_source=be5bd51fafff7d21180e251563899e5e)，并适当优化代码且修改错误，错误如下：  
<p align="center">
  <img src="./imgs/1.jpg" alt="错误1" width="600" />
</p> 
计算P(2,k)有问题，neighbor已经删除了不可访问节点，所以neighbor中节点的索引号和nodes_data{node_step, 4}索引号不是一一对应关系，应该先找到对应的索引号。  
修正：  
<p align="center">
  <img src="./imgs/2.jpg" alt="修正1" width="600" />
</p> 
